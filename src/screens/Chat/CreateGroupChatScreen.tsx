...
import { userCreateConversation } from "../../store/chat/chatActions";
...
const CreateGroupChatScreen = () => {
  ...
  const handleCreateGroup = async () => {
    if (selectedMembers.length === 0 || groupName.trim() === "") {
      Toast.show({
        type: "error",
        text1: t("group_name_and_members_required"),
      });
      return;
    }
    try {
